    ...
    <div className="flex flex-col flex-shrink-0 z-30">
      <header className="bg-white border-b border-gray-100 h-14 flex items-center px-8 justify-between">
        <div className="flex items-center text-xs font-bold text-gray-400">
          ...
          <button onClick={handleRootClick} className="hover:text-[#F2C94C] transition-colors cursor-pointer">管理扫地僧</button>
          ...
          >
            {view === 'home' || view === 'topic-detail' ? '学一学' : view === 'practice' ? '练一练' : view === 'diagnose-engine' ? '聊一聊' : '指挥官档案'}
          </button>
